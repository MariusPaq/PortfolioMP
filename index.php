...
<div id="home" class="home">
  ...
  <div id="projet" class="diapo projet">
    ...
    <div class="d-flex justify-content-center"  id="dflexproj1">
      <?php createCardProjet('Projet WordPress',"Développement d'un outil de communication sur Wordpress ayant vocation à sensibiliser sur l'importance de l'égalité femmes / hommes en contexte professionnel, en abordant le problème sous différents angles",'id1','Projet réaliser en groupe de trois avec Adeline Levionnois et Louis Meunier sur une durée de une semaine, création d’une maquette ainsi qu’un cahier des charges et ensuite un développement en local puis une mise en ligne du site.','WPE1.PNG','WPE2.PNG','<a href="https://mariusp.promo-42.codeur.online/egalitehf/">Egalité Homme Femme<a>'); ?>
      <?php createCardProjet('Flappy Bird','Création d’un jeu Flappy Bird en native JavaScript en duo avec Julie Boulenger. ','id2','Premier Projet en groupe effectuer à ONLINEFORMATPRO sur le language JS.','FB1.jpg','FB2.jpg','<a href="https://mariusp.promo-42.codeur.online/flappyBirds/">Play</a>'); ?>
      <?php createCardProjet('BigBlueButton',"Initialisation d'un serveur OVH avec Ubuntu 16.04 et installation d'une plateforme de visioconference 'BigBlueButton' pour l'entreprise Bien-Encré sur le dit serveur.",'id3',"Projet réaliser en grupe de quatre pour le stage de la formation à ONLINEFORMATPRO dans l'entreprise 'Bien-Encré' avec Adeline Levionnois, Tsiry Trafanoharantsoa et Dimitri Hoerth.",'BBB1.PNG','BBB2.PNG'); ?>
    </div>
    <div class="d-flex justify-content-center"  id="dflexproj2">
      <?php createCardProjet('Design Explorateur Fichiers',"Création de maquette pour un explorateur de fichier intervactive avec Adobe XD ",'id4','Premier projet et decouverte du logiciel Adobe XD.','',''); ?>
      <?php createCardProjet('Design Boulangerie',"Création d'une maquette pour une boulangerie avc le logiciel Photoshop.",'id5',"Premier maquette réaliser à ONLINEFORMATPRO avec le logiciel Photoshop.",'B1.PNG','boulangerie.jpg'); ?>
    </div>
